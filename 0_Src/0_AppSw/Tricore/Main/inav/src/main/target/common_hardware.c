...
#ifdef USE_DUAL_GYRO
        BUSDEV_REGISTER_SPI(busdev_mpu9250,     DEVHW_MPU9250,      MPU9250_SPI_BUS,    GYRO_0_CS_PIN,     GYRO_INT_EXTI,  DEVFLAGS_NONE);
#else
...
/** BAROMETERS **/
    ...
    BUSDEV_REGISTER_SPI(busdev_dps310,      DEVHW_DPS310,       DPS310_SPI_BUS,     DPS310_CS_PIN,      NONE,           DEVFLAGS_NONE);
    #elif defined(DPS310_I2C_BUS) || defined(BARO_I2C_BUS)
    #if !defined(DPS310_I2C_BUS)
        #define DPS310_I2C_BUS BARO_I2C_BUS
    #endif
    BUSDEV_REGISTER_I2C(busdev_dps310,      DEVHW_DPS310,       DPS310_I2C_BUS,     0x77,               NONE,           DEVFLAGS_NONE);
    #endif
#endif
